...
export const DataArray = [
  {
    ...
    des: "Built an AI-powered Medical QA system that improves medical query accuracy by 25% using FLAN-T5 with LoRA adapters and speech-to-text automation via Assembly AI, reducing manual input time by 40%.",
     des1: "This AI-driven system leverages Retrieval-Augmented Generation (RAG) to minimize hallucinations by 60%, using Hugging Face sentence-transformers and a FAISS vector store for real-time retrieval. A user-friendly interactive UI ensures smooth medical consultations.",
    images: ["/healthcare1.png", "/healthcare2.png"],
    techStack: ["Python", "TensorFlow", "Hugging Face", "FAISS", "FLAN-T5","Langchain", "Assembly AI"],
  ...
  },
  {
    ...
    des: "Developed a GRU-based deep learning model that predicts domestic flight fares with an R² score of 0.8852, leveraging seasonality, holidays, and time-based features for enhanced accuracy.",

    des1: "The model integrates cyclic time encoding to capture flight scheduling patterns, optimizing preprocessing with RobustScaler & OneHotEncoder. After training for 800+ epochs with early stopping, it delivers a high-precision fare estimation, improving decision-making in airline pricing strategies. ",
    //need to add images
    images: ["/flight1.png","/flight2.png","/flight3.png"],
    techStack: ["TensorFlow", "Pandas", "GRU"],
    id:"612"
  },
  {
