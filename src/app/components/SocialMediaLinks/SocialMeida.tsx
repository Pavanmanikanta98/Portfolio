...
export default function SocialMeida() {
  return (
    <div>
      <div className="flex flex-row sm:flex-col lg:flex-row justify-evenly">
        <a
          href="https://linkedin.com/in/pavanmanikanta98"
        ...
        <a
          href="https://github.com/pavanmanikanta98"
          className="text-gray-300 hover:text-[#999] transition-colors duration"
        >
          <svg
            stroke="currentColor"
        ...
        {/* <a
                href="https://instagram.com/pavanmanikanta98"
                className="text-gray-300 hover:text-[#999] transition-colors duration"
              >
                <svg
                  stroke="currentColor"
